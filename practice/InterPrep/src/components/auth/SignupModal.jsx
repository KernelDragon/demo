                    ...
                    <div className={`p-8 md:p-12 flex flex-col ${isDark ? 'bg-slate-900' : 'bg-white'}`}>
                        ...
                        <div className="mb-8 mt-4">
                            ...
                            <p className={`text-sm ${isDark ? 'text-slate-400' : 'text-slate-600'}`}>
                                Start your interview preparation journey with <span className="font-semibold">InterPrep</span>. Create your account for free.
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="flex-1 flex flex-col space-y-4">
                            ...
                            <div className="flex items-center gap-4 my-4">
                                ...
                                <span className={`text-sm ${isDark ? 'text-slate-400' : 'text-slate-600'}`}>or sign up with</span>
                                <div className={`flex-1 h-px ${isDark ? 'bg-slate-700' : 'bg-slate-300'}`} />
                            </div>
